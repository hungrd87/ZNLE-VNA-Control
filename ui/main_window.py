...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        # Initialize - Optimized window size for better plot visibility
        self.setWindowTitle("ZNLE VNA Control")
        self.resize(1200, 800)                  # Keep height at 800px for plot area
    ...
    def setup_ui(self):
        ...
        # Set initial splitter sizes (25% controls, 75% plot) - More space for plot
    ...
    def create_control_panel(self) -> QWidget:
        """Create the left control panel with compact layout"""
        panel = QWidget()
        layout = QVBoxLayout(panel)
        layout.setContentsMargins(4, 4, 4, 4)      # Compact margins
        layout.setSpacing(6)                        # Reduced spacing between components
        ...
        tab_widget.addTab(self.sweep_widget, "Parameters")
    ...
    def create_plot_panel(self) -> QWidget:
        """Create the right plot panel with full expansion"""
        panel = QWidget()
        layout = QVBoxLayout(panel)
        layout.setContentsMargins(2, 2, 2, 2)      # Minimal margins for plot
        layout.setSpacing(2)                       # Minimal spacing
        
        # Plot widget with full expansion
    ...
    def update_status_labels(self, status_dict: dict):
        ...
        if hasattr(self.sweep_widget, 'update_status_labels'):
            self.sweep_widget.update_status_labels(status_dict)
